...
| `ClientParams` | [QueryClientParamsRequest](#ibc.core.client.v1.QueryClientParamsRequest) | [QueryClientParamsResponse](#ibc.core.client.v1.QueryClientParamsResponse) | ClientParams queries all parameters of the ibc client submodule. | GET|/ibc/core/client/v1/params|
...
| `ConnectionParams` | [QueryConnectionParamsRequest](#ibc.core.connection.v1.QueryConnectionParamsRequest) | [QueryConnectionParamsResponse](#ibc.core.connection.v1.QueryConnectionParamsResponse) | ConnectionParams queries all parameters of the ibc connection submodule. | GET|/ibc/core/connection/v1/params|
